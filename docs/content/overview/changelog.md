...
* Update gRPC dependency to fix 'DNS name does not exist' error. ([#426](https://github.com/mxc-foundation/chirpstack-application-server/issues/426))
...
* Add uplink IDs used for gelocation to geolocation event. ([#413](https://github.com/mxc-foundation/chirpstack-application-server/issues/413))
* Internal cleanup of unused `device_activation` table and code.
* Add option for 200 and 500 items per page in web-interface. ([#418](https://github.com/mxc-foundation/chirpstack-application-server/pull/418))

### Bugfixes

* Fix LoRaWAN 1.1 OTAA bug (and update tests). ([#382](https://github.com/mxc-foundation/chirpstack-application-server/issues/382))
* Fix assigning device profile to device (validate they share the same organization). ([#415](https://github.com/mxc-foundation/chirpstack-application-server/issues/415))
...
* Check for null values in JSONTree web-interface component. ([#398](https://github.com/mxc-foundation/chirpstack-application-server/issues/398))
...
* Fix integrations break when codec function returns a NaN value. ([#390](https://github.com/mxc-foundation/chirpstack-application-server/issues/390))
...
This is the first release providing .rpm packages for CentOS and RedHat. ([#383](https://github.com/mxc-foundation/chirpstack-application-server/pull/383)
...
* Deprecate use of dots (`.`) in environment variable names, use double underscore (`__`) instead. ([#369](https://github.com/mxc-foundation/chirpstack-application-server/issues/369))

### Bugfixes

* Fixes init stop script which could cause the ChirpStack Application Server to not properly stop or restart. ([#379](https://github.com/mxc-foundation/chirpstack-application-server/issues/379))
...
* Persist selected number of table rows per page in localStorage. ([#351](https://github.com/mxc-foundation/chirpstack-application-server/issues/351))
...
* Add RXInfo and TXInfo to join-notifications. ([#235](https://github.com/mxc-foundation/chirpstack-application-server/pull/347))

### Bugfixes

* Propagate gRPC errors to that the correct HTTP status is returned. ([#349](https://github.com/mxc-foundation/chirpstack-application-server/issues/349))
* Fix not found UI error when device is inactive. ([#359](https://github.com/mxc-foundation/chirpstack-application-server/issues/359))
...
* Show popup on gateway create when no Service Profile exists. ([#345](https://github.com/mxc-foundation/chirpstack-application-server/issues/345))
* Remove unused fields when listing users. ([#328](https://github.com/mxc-foundation/chirpstack-application-server/issues/345))
* Update multicast address and session-key input field widgets.
* Mention in API description that the organization ID of an application can not be updated after create. ([#343](https://github.com/mxc-foundation/chirpstack-application-server/issues/343))

### Bugfixes

* Trigger organization dropdown reload on organization change. ([#342](https://github.com/mxc-foundation/chirpstack-application-server/issues/342))
...
* Multicast-group frame-counter cleanup (there was a column in both the LoRa App Server and LoRa Server database). ([#339](https://github.com/mxc-foundation/chirpstack-application-server/issues/339))
...
* Speedup login with default admin / admin credentials (for low CPU power devices). ([#320](https://github.com/mxc-foundation/chirpstack-application-server/issues/320))
* Gateway ID, FPGA ID and AES-key widgets have been updated.
* Always display Class-C timeout field in Device Profile.

### Bugfixes

* Fix Gen Application Key is no longer a mandatory field. ([#322](https://github.com/mxc-foundation/chirpstack-application-server/issues/322))
* Fix create organization user. ([#323](https://github.com/mxc-foundation/chirpstack-application-server/issues/323))
...
* Fix organization admin cannot add existing users. ([#315](https://github.com/mxc-foundation/chirpstack-application-server/issues/315))
...
* Fix `panic` when JOSN object is set but contains `null`. ([#314](https://github.com/mxc-foundation/chirpstack-application-server/issues/314))
...
* Add configuration option for CORS headers. ([#275](https://github.com/mxc-foundation/chirpstack-application-server/pull/275))
...
* Improve authentication validator SQL query for speed. ([#302](https://github.com/mxc-foundation/chirpstack-application-server/pull/302))
* Add codec execution time for decoding. ([#307](https://github.com/mxc-foundation/chirpstack-application-server/pull/307))
* UI: Make delete application confirmation more explicit. ([#306](https://github.com/mxc-foundation/chirpstack-application-server/pull/306))

## v2.5.1

### Bugfixes

* Fix panic in InfluxDB handler on `null` values in object ([#295](https://github.com/mxc-foundation/chirpstack-application-server/issues/295))
...
immediately when a MQTT client connects. ([#272](https://github.com/mxc-foundation/chirpstack-application-server/pull/272))
...
* Fix logrotate issue (init based systems) ([#282](https://github.com/mxc-foundation/chirpstack-application-server/pull/282)
...
* Use `gofrs/uuid` UUID library as `satori/go.uuid` is not truly random. ([#253](https://github.com/mxc-foundation/chirpstack-application-server/pull/253))
...
* Lock device row on downlink enqueue to avoid duplicated frame-counter values ([#245](https://github.com/mxc-foundation/chirpstack-application-server/issues/245))
...
* Fix discovery interval validation ([#226](https://github.com/mxc-foundation/chirpstack-application-server/issues/226)).
...
* Expose LoRa Server version and configured region through the network-server
  API endpoint.
* Websocket client automatically re-connects on connection error ([#221](https://github.com/mxc-foundation/chirpstack-application-server/pull/221))
...
* Added streaming frame-logs for gateways (which also can be downloaded as JSON file).
  * You need LoRa Server 0.24+ in order to use this feature.
* Support MQTT client certificate authentication ([#201](https://github.com/mxc-foundation/chirpstack-application-server/pull/201)).
...
* `--gw-ping-dr 0` is now handled correctly ([#204](https://github.com/mxc-foundation/chirpstack-application-server/pull/204))
...
* Fix ABP sesstings not editable by organization admin
  ([#85](https://github.com/mxc-foundation/chirpstack-application-server/issues/85))
...
* A pagination regression has been fixed ([#82](https://github.com/mxc-foundation/chirpstack-application-server/issues/82)).
