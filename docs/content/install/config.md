...
ChirpStack Application Server is an open-source application-server, part of the ChirpStack Network Server project
	...
	> source & copyright information: https://github.com/mxc-foundation/chirpstack-application-server
...
# (see https://github.com/mxc-foundation/chirpstack-application-server/tree/master/migrations)
